...
int EMUCOpenSocketCAN   (int com_port);  /* linux only */
#endif
...
typedef int(*EMUC_ENABLE_SEND_QUEUE)(int com_port, bool is_enable, unsigned int queue_size);
